    ...
    <footer className="w-full px-margin-mobile md:px-margin-desktop py-16 flex flex-col items-center gap-base text-center bg-primary-container dark:bg-primary-container mt-24">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
        ...
        <div className="flex items-center gap-6 text-on-primary-container">
          <a href="#" className="hover:text-surface-bright transition-colors flex items-center gap-2" title="Instagram">
          ...
          <a href="#" className="hover:text-surface-bright transition-colors flex items-center gap-2" title="Facebook">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
